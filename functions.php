...
if( !function_exists("wp_bootstrap_theme_styles") ) {  
    function wp_bootstrap_theme_styles() { 
        ...
        wp_register_style( 'wpbs', get_template_directory_uri() . '/library/dist/css/main.min.css', array(), '1.0', 'all' );
...
if( !function_exists( "wp_bootstrap_theme_js" ) ) {  
  function wp_bootstrap_theme_js(){
    ...
    //   get_template_directory_uri() . '/bower_components/bootstrap-sass/dist/js/bootstrap.js', 
    //   array('jquery'), 
    //   '1.2' );

    wp_register_script( 'wpbs-js', 
      get_template_directory_uri() . '/library/dist/js/theme.min.js',
      array('bootstrap'), 
      '1.2' );
